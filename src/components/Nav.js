        ...
        <>
            <div className='container-fluid'>
                <div className='row justify-content-end'>
                    <div className='col-2 fixed-top ' style={{ background: "#040440", color: "white", height: "100vh" }}>
                        ...
                        <nav className="navbar bg-#040440 ">
                            ...
                            <div className="container im" style={{ maxWidth: '24rem' }}>
                                <a className="text-white navbar-brand mb-0 h1" href="/">
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="16" fill="currentColor" className="bi bi-speedometer2" viewBox="0 0 16 16">
                        ...
                        <nav className="navbar bg-body-tertiary-#040440">
                            <div className="container im" style={{ maxWidth: '24rem' }}>
                                <a className="navbar-brand text-white md-0 h1" href="/" >
                                    <svg xmlns="http://www.w3.org/2000/svg" width="35" height="16" fill="currentColor" className="bi bi-boxes" viewBox="0 0 16 16">
                        ...
                        <nav className="navbar bg-body-tertiary-#040440">
                            <div className="container im" style={{ maxWidth: '24rem' }}>
                                <a className="navbar-brand text-white" href="/">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="35" height="16" fill="currentColor" className="bi bi-person-circle" viewBox="0 0 16 16">
                        ...
                        <nav className="navbar bg-body-tertiary-#040440">
                            <div className="container im" style={{ maxWidth: '24rem' }}>
                                <a className="navbar-brand text-white" href="/">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="35" height="16" fill="currentColor" className="bi bi-wallet2" viewBox="0 0 16 16">
                        ...
                        <nav className="navbar bg-body-tertiary-#040440">
                            <div className="container im" style={{ maxWidth: '24rem' }}>
                                <a className="navbar-brand text-white" href="/">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="35" height="16" fill="currentColor" className="bi bi-patch-check" viewBox="0 0 16 16">
                        ...
                        <nav className="navbar bg-body-tertiary-#040440">
                            <div className="container im" style={{ maxWidth: '24rem' }}>
                                <a className="navbar-brand text-white" href="/">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="35" height="16" fill="currentColor" className="bi bi-chat-right-dots" viewBox="0 0 16 16">
                        ...
                        <div className='container text-center'>
                            <div className="dropdown fixed-bottom p-4">
                                <a href="/" className="d-flex align-items-center text-white text-decoration-none dropdown-toggle" id="dropdownUser1" data-bs-toggle="dropdown" aria-expanded="false">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="40" height="16" fill="currentColor" className="bi bi-person-bounding-box" viewBox="0 0 16 16">
